...
export interface Dictionary<T> {
     ...
     */
    __forEach(isFirstBeforeSecond: (first: string, second: string) => boolean, $v: ($: T, key: string) => void): void;
    /**
     ...
     * gets an entry. If the entry does not exist, the code will panic and terminate.
     */
    __getEntryOrPanic(key: string): T;
    /**
     ...
     * @param key
     */
    __getOptionalEntry(key: string): OptionalValue<T>;
}
