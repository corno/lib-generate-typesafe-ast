...
export const $$: A.createImplementationSerializer = ($d) => {
...
export const $$:C${$.key} = `)
                                                    ...
                                                    $i.indent(($i) => {
                                                        if ($.innerFunctions !== undefined) {
                                                            $d.dictionaryForEach($.innerFunctions, ($) => {
                                                                $i.nestedLine(($i) => {
                                                                    $i.snippet(`function ${$.key}($: gapi.T.${$d.createIdentifier($.key)}, $i: g_fp.SYNC.I.Line) `)
        ...
        // function serializeExpression($: galgorithm.TExpression, $i: g_fp.SYNC.I.Line) {
        //     switch ($[0]) {
        //         case 'call':
        //             pl.cc($[1], ($) => {
        //                 $i.snippet(`${$.function}(`)
        ...
        //     }
        // }
        // function serializeCallbackBlock($: galgorithm.TCallbackBlock, $i: g_fp.SYNC.I.Line) {
        //     $i.snippet(`{`)
        //     $i.indent(($i) => {
        ...
        //     $i.snippet(`}`)
        // }
        // function serializeFunctionBlock($: galgorithm.TFunctionBlock, $i: g_fp.SYNC.I.Line) {
        //     $i.snippet(`{`)
        //     $i.indent(($i) => {
        //         if ($.innerFunctions !== undefined) {
